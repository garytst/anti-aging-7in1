(function() {
    ...
    // Inject a style tag to hide body content but keep overlay visible
    var styleTag = document.createElement('style');
    styleTag.id = 'auth-hide-style';
    styleTag.textContent = 'body > *:not(#auth-overlay):not(script) { display:none !important; } body { overflow:hidden !important; }';
    ...
    function showPasswordScreen() {
        ...
        overlay.style.cssText = 'position:fixed;inset:0;z-index:999999;background:linear-gradient(135deg,#0a0e1a 0%,#0d1525 50%,#0a0e1a 100%);display:flex;align-items:center;justify-content:center;font-family:"Noto Sans TC","Inter",sans-serif;';
        overlay.innerHTML = `
            <div style="
        ...
        async function tryLogin() {
            ...
            if (hash === PASS_HASH) {
                saveAuth();
                overlay.remove();
                // Remove the hide style to show all content
